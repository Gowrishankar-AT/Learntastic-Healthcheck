...
[![Java CI with Maven](https://github.com/thinktimetechno/AutomationFrameworkCucumberTestNG/actions/workflows/maven.yml/badge.svg)](https://github.com/thinktimetechno/AutomationFrameworkCucumberTestNG/actions/workflows/maven.yml)
...
- Setup **Allure**:
  ...
  or
  https://thinktimetechno.com/blog/selenium-java/selenium-java-tai-nguyen-cai-dat-moi-truong)
...
- Run Cucumber TestRunner from **src/test/java/thinktimetechno/com/runners**
...
- Config mail with email and password in **_src/main/java/thinktimetechno/com/mail/EmailConfig.java_**
...
- Call class: Log.info , Log.pass, Log.error,... (**Log** is a custom global class from Log4j2)
  (**_import thinktimetechno.com.utils.Log.java_**)
...
- Create function with annotaion **DataSupplier** on **_src/main/java/thinktimetechno/com/utils/DataProviderUtils.java_**
- Call the name of **DataSupplier** above in the test cases as DataProvider of TestNG
- Read excel with Map and Hashtable

**9. Base function in the package**

- **_src/main/java/thinktimetechno/com/utils_**
- **_src/main/java/thinktimetechno/com/helpers_**
...
- Run test case TestNG: src/test/java/thinktimetechno/com/projects/website/crm/testcases
